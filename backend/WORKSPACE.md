...
> Claude updates this file after every task. Last updated: 2026-07-30 (GCP migration: backend + parallel frontend live on Cloud Run; secrets in Secret Manager; GitHub push-to-deploy CI/CD wired)
